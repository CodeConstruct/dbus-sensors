...
void NVMeSubsystem::markFunctional(bool toggle)
{
    ...
    {
        throw std::runtime_error("cannot start: subsystem initialisation has aborted and must transition to stopped");
    }
...
std::shared_ptr<NVMeControllerEnabled> NVMeSubsystem::getPrimaryController() const
{
